<?php
//Include Common Files @1-F3264A2C
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "DiputadoDetalle.php");
...
//Show Method @92-39C7BBC2
    function Show()
    {
        ...
        $this->DataSource->Parameters["urlcircunscripcion"] = CCGetFromGet("circunscripcion", NULL);
...
//Open Method @92-C72E94FC
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["circ"] = new clsSQLParameter("urlcircunscripcion", ccsInteger, "", "", CCGetFromGet("circunscripcion", NULL), 11, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spDiputadosTally " . $this->ToSQL($this->cp["circ"]->GetDBValue(), $this->cp["circ"]->DataType) . ";";
...
//Open Method @77-C776F43C
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["circ"] = new clsSQLParameter("urlcircunscripcion", ccsInteger, "", "", CCGetFromGet("circunscripcion", NULL), 11, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spDiputadosDetalle " . $this->ToSQL($this->cp["circ"]->GetDBValue(), $this->cp["circ"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Open Method @93-BB92FBB8
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["circ"] = new clsSQLParameter("urlcircunscripcion", ccsInteger, "", "", CCGetFromGet("circunscripcion", NULL), 11, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spDiputadosProyPart " . $this->ToSQL($this->cp["circ"]->GetDBValue(), $this->cp["circ"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Open Method @97-346A83F6
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["circ"] = new clsSQLParameter("urlcircunscripcion", ccsInteger, "", "", CCGetFromGet("circunscripcion", NULL), 11, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spDiputados " . $this->ToSQL($this->cp["circ"]->GetDBValue(), $this->cp["circ"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "DiputadoDetalle.html";
$BlockToParse = "main";
...
//Go to destination page @1-6BFE6F03
if($Redirect)
{
