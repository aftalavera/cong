<?php
//Include Common Files @1-1821C453
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "SenadorDetalle.php");
...
//Open Method @92-6B032F9B
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), 1, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spSenadoresTally " . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
...
//Open Method @97-9C178BB6
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), 1, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spSenadores " . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Open Method @77-EF7E38BA
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), 1, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spSenadoresDetalle " . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Open Method @93-A1B4CB40
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->cp["provincia"] = new clsSQLParameter("urlprovincia", ccsInteger, "", "", CCGetFromGet("provincia", NULL), 1, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spSenadoresProyPart " . $this->ToSQL($this->cp["provincia"]->GetDBValue(), $this->cp["provincia"]->DataType) . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SenadorDetalle.html";
$BlockToParse = "main";
...
//Go to destination page @1-BA368AE3
if($Redirect)
{
