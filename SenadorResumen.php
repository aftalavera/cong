<?php
//Include Common Files @1-F5BC43C4
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "SenadorResumen.php");
...
//Class_Initialize Event @130-D1822311
    function clsRecordSelectForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->provincia = new clsControl(ccsListBox, "provincia", "provincia", ccsText, "", CCGetRequestParam("provincia", $Method, NULL), $this);
            $this->provincia->DSType = dsTable;
            $this->provincia->DataSource = new clsDBmssql();
            $this->provincia->ds = & $this->provincia->DataSource;
            $this->provincia->DataSource->SQL = "SELECT * \n" .
"FROM Provincias {SQL_Where} {SQL_OrderBy}";
            $this->provincia->DataSource->Order = "nombre";
            list($this->provincia->BoundColumn, $this->provincia->TextColumn, $this->provincia->DBFormat) = array("cod_prov", "nombre", "");
            $this->provincia->DataSource->Order = "nombre";
...
//CheckErrors Method @130-649B9775
...
//Operation Method @130-1F67D35A
    function Operation()
    {
        ...
        $Redirect = "SenadorDetalle.php" . "?" . CCGetQueryString("All", array("ccsForm"));
...
//DataSource Variables @130-8D452C18
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @130-BEDB89C4
...
class clsGridGrid4 { //Grid4 class @236-95205137

//Variables @236-6E51DF5A
...
//Class_Initialize Event @236-5EB0277A
...
//Initialize Method @236-90E704C5
    function Initialize()
    {
        if(!$this->Visible) return;
...
} //End Grid4 Class @236-FCB6E20C

class clsGrid4DataSource extends clsDBmssql {  //Grid4DataSource Class @236-629FF6AD

//DataSource Variables @236-D0D9FA10
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @236-EB7CEB3C
...
//Open Method @236-B7C9738F
    function Open()
    {
        $this->cp["RETURN_VALUE"] = new clsSQLParameter("urlRETURN_VALUE", ccsInteger, "", "", CCGetFromGet("RETURN_VALUE", NULL), "", false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "EXEC spSenadoresResumenGeneral " . ";";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query($this->SQL);
        $this->RecordsCount = "CCS not counted";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
} //End Grid4DataSource Class @236-FCB6E20C
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SenadorResumen.html";
$BlockToParse = "main";
...
//Go to destination page @1-3AA012F2
if($Redirect)
{
